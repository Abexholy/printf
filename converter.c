...
/**
 * append_hexa_cod - Append ascii in hexadecimal code
 * to buffer
 * @buffer: Array of chars.
 * @a: Index at which to start appending
 * @ascii_cod: ASCII CODE
 *
 * Return: Always 3
 */
int append_hexa_cod(char ascii_cod, char buffer[], int a)
{
...
/**
 * is_a_digit - Varifies if a char is a digit
 * @c: Char to be evaluated
 *
...
/**
 * convert_number_size - Casts a number to the specified
 * size
...
/**
 * convert_size_unsigned - Casts a number to the specified
 * size
 * @n: Number to be casted
 * @size:Number indicating the type to be casted
 *
